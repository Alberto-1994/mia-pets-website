...
const CategoryPage = () => {
  ...
  const categoryNames: { [key: string]: string } = {
    ...
    correas: 'Correas para Mascotas'
  }

  const products = generateProducts(categoria, 30)
  ...
  const CategoryIcon = categoryIcons[categoria] || ShoppingBag
    ...
    <div className="min-h-screen pt-16">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          >
            <CategoryIcon className="h-16 w-16 mx-auto mb-6" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-12">
              <CategoryIcon className="h-16 w-16 mx-auto mb-4 text-gray-400" />
